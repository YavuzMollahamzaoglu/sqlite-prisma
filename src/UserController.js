...
app.put("/user", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    */
    ...
    res.send(`User is created successfully.User:${(req.body.name, req.body.email)}`);
}));
...
app.get("/users/:age", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const age = Number(req.params);
